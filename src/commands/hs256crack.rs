...
const METAL_SOURCE_PATH: &str = "src/kernels/hs256_brute_force.metal";
const METAL_FUNCTION_NAME: &str = "hs256_brute_force";
...
impl GpuHs256BruteForcer {
    fn new() -> anyhow::Result<Self> {
        ...
        let function = library
            .get_function(METAL_FUNCTION_NAME, None)
            .map_err(|e| anyhow!("failed to get Metal function {METAL_FUNCTION_NAME}: {e}"))?;
        let pipeline = device
